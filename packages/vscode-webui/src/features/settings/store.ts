...
export interface SettingsState {
  ...
  updateEnableCopilotModels: (value: boolean) => void;
}
...
export const useSettingsStore = create<SettingsState>()(
  persist(
    (set) => ({
      ...
      updateEnableCopilotModels: (value: boolean) =>
        set(() => ({ enableCopilotModels: value })),
    }),
    {
