...
const ToolDescriptions: Record<ToolName, string> = {
  ...
  writeToPlan:
    "The writeToPlan tool allows Pochi to document the proposed changes, goals, and verification steps for a given task. This helps Pochi organize its thoughts and communicate its plan effectively. It ensures that Pochi has a clear roadmap before proceeding with implementation.",
  readPlan:
    "The readPlan tool allows Pochi to review the previously documented plan, including proposed changes, goals, and verification steps. This helps Pochi to stay on track and ensure that the implementation aligns with the agreed-upon strategy.",
  startBackgroundJob:
