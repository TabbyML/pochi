...
const ToolDescriptions: Record<Exclude<ToolName, "createReview">, string> = {
  ...
  renderWidget:
    "The renderWidget tool renders a local HTML/SVG widget in the VSCode chat. It is used for streaming diagrams, mockups, simple charts, art, and local-only interactive UI. Widgets cannot call the model, use host actions, request external APIs, or load external resources.",
  killBackgroundJob:
