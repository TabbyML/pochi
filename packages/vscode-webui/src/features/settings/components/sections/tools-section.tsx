...
const ToolDescriptions: Record<ToolName, string> = {
  ...
  skill:
    "The skill tool allows Pochi to access and execute specialized skills that are available in your workspace. Skills are reusable, packaged instructions for specific tasks or workflows. When you have skills configured in your workspace, Pochi can use this tool to retrieve the instructions for a particular skill and then follow those instructions to complete complex, domain-specific tasks.\n\nFor example, if you have a skill for 'code review', 'database migration', or 'API documentation generation', Pochi can use this tool to access those specialized workflows. This extends Pochi's capabilities beyond its built-in tools, allowing it to leverage custom automation and best practices specific to your project or organization.",
};
