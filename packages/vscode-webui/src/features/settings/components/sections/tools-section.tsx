...
const ToolDescriptions: Record<ToolName, string> = {
  ...
  createReview:
    "The createReview tool allows Pochi to add inline review comments to specific lines in your code. These comments appear in the VSCode gutter and in the Reviews panel, making it easy to see feedback directly alongside your code.\n\nThis tool is primarily used by the reviewer agent to perform code reviews. When analyzing code, Pochi can use createReview to highlight issues, suggest improvements, point out potential bugs, or provide constructive feedback. Each review comment is attached to a specific line range, making it clear exactly which code the feedback applies to.",
};
