...
const ToolDescriptions: Record<Exclude<ToolName, "createReview">, string> = {
  ...
  completeTodo:
    "This tool audits the active todo and updates its status. Pochi calls it after making concrete progress and before it would otherwise finish a todo turn.\n\nThe audit runs separately and returns whether automatic continuation should stop, along with a short summary. The actual task state is shown by the todo status.",
  executeCommand:
