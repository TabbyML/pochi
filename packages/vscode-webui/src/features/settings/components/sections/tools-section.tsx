...
const ToolDescriptions: Record<Exclude<ToolName, "createReview">, string> = {
  ...
  renderWidget:
    "The renderWidget tool renders a local HTML/SVG widget in the VSCode chat. It is used for streaming diagrams, mockups, simple charts, art, and local interactive UI. Widgets store JSON state on a top-level <pochi-widget> element and may send widget-authored follow-up prompts; they still cannot use external APIs or load external resources.",
  killBackgroundJob:
