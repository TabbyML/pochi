...
describe("custom sub-agent views", () => {
  beforeEach(() => {
  ...
  it("keeps the browser trajectory in the card body until a frame or video exists", () => {
  ...
  it("shows the browser trajectory in the footer when a live frame is in the card body", async () => {
    useStoreFileMock.mockReturnValue(undefined);
  ...
  it("shows the browser trajectory in the footer when a recording video is in the card body", () => {
  ...
  it("shows a stopped browser recording even if the parent task is still executing", () => {
    useStoreFileMock.mockReturnValue({ content: "blob://recording" });
  ...
  it("keeps the planner trajectory in the card body until a plan exists", () => {
    useStoreFileMock.mockReturnValue(undefined);
  ...
  it("shows the planner trajectory in the footer when a plan is in the card body", () => {
