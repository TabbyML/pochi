---
title: 'Querying SQL in Natural Language with a custom Supabase MCP Server in Pochi'
---

# Querying SQL in Natural Language with a custom Supabase MCP Server in Pochi

In this tutorial, you’ll learn how to query your database using natural language directly from your code editor, with a custom MCP server that connects Supabase in Pochi.
