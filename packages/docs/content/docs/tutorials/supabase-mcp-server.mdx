...
For the OpenAI key, go to your dashboard and API keys section where you can click "+Create a secret key" button. 
...
const supabaseUrl = "https://kzatrevowpeaueroqyqe.supabase.co";
...
>
  <iframe
    src="https://drive.google.com/file/d/1QAqFqfLonMNcsK8avFUV48jsTI8XWOSh/preview"
    style={{
      position: "absolute",
      top: 0,
      left: 0,
