---
title: 'How to Build a Custom MCP Server to Query Supabase with Natural Language in Pochi'
---

# How to Build a Custom MCP Server to Query Supabase with Natural Language in Pochi
