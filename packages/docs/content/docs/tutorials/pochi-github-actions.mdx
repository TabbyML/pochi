...
```
 ...
 <video
    ...
    >
        <source src="https://assets.docs.getpochi.com/pochi-review-step1-gh-actions-tut.mp4" type="video/mp4" />
...
```
 ...
 <video
    ...
    >
        <source src="https://assets.docs.getpochi.com/pochi-fixes-step1-github-actions.mp4" type="video/mp4" />
        Your browser does not support the video tag.
    </video>
...
Click on Generate and copy the token. 
 ...
 <video
    ...
    >
        <source src="https://assets.docs.getpochi.com/creating-pat-token-gh-actions-tut.mp4" type="video/mp4" />
        Your browser does not support the video tag.
    </video>
...
Now you can propose the changes as a PR. 
 ...
 <video
    ...
    >
        <source src="https://assets.docs.getpochi.com/summarise-with-pat-gh-actions-tutorial.mp4" type="video/mp4" />
        Your browser does not support the video tag.
    </video>
...
When you create a new issue Pochi, fill in your title and description, being as clear as possible and Pochi will comment out draft design notes to help you with your implementation.  Below is a example execution:
 ...
 <video
    ...
    >
        <source src="https://assets.docs.getpochi.com/create-issue-suggestion-gh-actions-tut.mp4" type="video/mp4" />
        Your browser does not support the video tag.
    </video>
...
We ran this workflow on a sample task management project. The demo below is the part where changes were required:
 ...
 <video
    ...
    >
        <source src="https://assets.docs.getpochi.com/gatekeeper-bad-review-gh-actions-tut.mp4" type="video/mp4" />
        Your browser does not support the video tag.
    </video>
...
Here is a demo showing when changes were approved:
 ...
 <video
    ...
    >
        <source src="https://assets.docs.getpochi.com/pr-gatekeeper-good-review-gh-actions.mp4" type="video/mp4" />
        Your browser does not support the video tag.
    </video>
...
Now, add some `// TODO: improve validation` lines in `src/server.ts`. Commit the code, then go to Actions → Pochi Continuous Agent → Run workflow. You’ll see Pochi create new issues from the TODOs it scanned in your codebase.
 ...
 <video
    ...
    >
        <source src="https://assets.docs.getpochi.com/todocron -job-gh-actions-tut.mp4" type="video/mp4" />
        Your browser does not support the video tag.
    </video>
