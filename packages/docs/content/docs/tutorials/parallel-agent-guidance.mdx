...
You can create worktrees from the Pochi sidebar using **"New Workspace"** mode. Simply start chatting with a prompt, and Pochi will automatically create a new worktree and launch the agent task:
