...
- **Gemini 3 Support:** We’ve also added support for Gemini 3 Pro alongside 2.5. The UI for model selection, pricing, and routing has been updated accordingly.
<div class="w-12/15 md:ml-8 *:shadow-xl/30 *:rounded-lg">![Gemini 3 Support](./images/gemini-3pro-support.png)</div>


### ✨ Enhancements

- **Line Wrap Toggle in Code Blocks:** We added a line wrap toggle to the code block component in the VS Code extension. This way, long lines inside diffs and model edits are now way easier to read, especially when reviewing wide changes or generated code.
