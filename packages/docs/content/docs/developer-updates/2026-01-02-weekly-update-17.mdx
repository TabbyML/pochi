...
This release we focused on improving how you review, refine, and iterate on agent-generated code inside VS Code, along with bug fixes that increase correctness and stability during multi-step agent runs.
