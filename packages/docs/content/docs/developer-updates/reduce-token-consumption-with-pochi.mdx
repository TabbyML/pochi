---
title: 'How to Use Pochi to Prevent Context Bloat and Control Token Costs'
description: "Developers are trying to make LLMs write code, but few are teaching them how to engineer"
image: "/og-image/rog-cover-image-reduce-tokens.png"
---

# How to Use Pochi to Prevent Context Bloat and Control Token Costs
...
![Token consumption Cover Image](./images/cover-image-reduce-tokens-via-pochi.png)

At Pochi, our core philosophy is that you should never have to think about token cost explicitly. Token cost is a workflow design problem. Our system is designed to help you reset, scope, or refocus work before noise accumulates and context drifts. Pochi works as an extension of your development workflow, staying in sync as you edit code, explore ideas, and move between tasks.
...
#### What to watch for:
- The agent repeats earlier failed approaches.
- Responses become longer without improving.
...
#### What to watch for:
- You’re repeatedly saying “no, not that file” or “change this part.”
- The agent keeps re-reading the same code blocks.
...
#### What to watch for:
- The agent tries to reconcile old and new directions.
- You see long “multi-threaded” reasoning.
...
#### What to watch for:
- The agent suggests tools unrelated to the task.
- You see long reasoning chains before the agent chooses a tool.
...
#### What to watch for:
- The agent pulls full rows instead of aggregating.
- Your prompt is ambiguous (“find refunded orders and tell me how many”).
