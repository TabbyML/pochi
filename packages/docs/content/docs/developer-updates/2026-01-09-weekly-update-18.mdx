...
We’re back to shipping, and this release includes changes to how follow-up prompts use your local edits, how Auto Layout is enabled, and a few UI fixes that remove common friction points.
