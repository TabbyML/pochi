...
- **New keyboard shortcut:** Added a `Ctrl+` keybinding in VSCode to instantly toggle the Pochi layout or open the terminal, improving keyboard-first navigation. This shortcut only exists as an advance configuration at the moment. To enable it, toggle `enablePochiLayoutKeybinding` in Pochi Advanced setting to `true`.**[#881](https://github.com/TabbyML/pochi/issues/881)**
