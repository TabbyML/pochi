...
4. Add it to your GitHub repository as a secret named `POCHI_TOKEN`. See [GitHub's official guide](https://docs.github.com/en/actions/how-tos/write-workflows/choose-what-workflows-do/use-secrets) for detailed steps:
   - Go to **Settings** → **Secrets and variables** → **Actions**
   - Click **"New repository secret"**
   - Name: `POCHI_TOKEN`, Value: your API key
