...
This week, we introduced **Queued Messages** — type prompts in advance and stop waiting for Pochi to finish a task! We also launched a new **Tutorials section** with guides on voice-driven dev and Mermaid graphs. Have tips or insights? Contribute your own via PRs! Plus, Pochi now supports more file types, and the CLI is friendlier and more interactive. ✨

### Features 🚀

- **[Queued Messages](https://docs.getpochi.com/queued-messages/):** Type your prompts in advance instead of waiting for Pochi to finish. [#286](https://github.com/TabbyML/pochi/pull/286)
- **[Tutorials](https://docs.getpochi.com/tutorials/):** A new hub to help you get more out of Pochi. This week: voice-driven dev with Hex, and Mermaid graph communication. [#345](https://github.com/TabbyML/pochi/pull/345), [#346](https://github.com/TabbyML/pochi/pull/346).

### Enhancements ✨

- **Mutlimedia File support:** Share not just images, but also PDFs and videos with Pochi. [#271](https://github.com/TabbyML/pochi/pull/271)
