...
- **More CLI commands:** `pochi mcp list` to inspect configured MCP servers, [#231](https://github.com/TabbyML/pochi/pull/231) `pochi task list` to check task lists. [#266](https://github.com/TabbyML/pochi/pull/266)
