...
<Callout type="info" title="Cloud IDE">
   When you send messages to Pochi in Slack, tasks are executed in a Cloud IDE, so you can collaborate without needing local development environments.
</Callout>
...
### Seamlessly Continue in a Cloud IDE
