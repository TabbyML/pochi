...
- Respects .gitignore, so git-ignored content is not searched. To search git-ignored content, use grep or rg with the appropriate flags (e.g. rg --no-ignore) via the terminal.
